...
<body>
	...
	<div class="navigation-container header" id="myHeader">
		...
		<h1 style="text-align: center; color: #0f3057;">Find your <span style="color: #46b3e6;">doctors</span></h1>
		<p style="text-align: center; letter-spacing: 5px; margin-top: 5px;">Whom you really need!</p>
	<hr>
        ...
        while($row=mysqli_fetch_array($result))
        {
            if($newrow%4==0 and $newrow!=0)
            {
                ...
                $newrow++;
                        ...
                        if($row['DocID']>20) {echo '<img class="card-img-top" src="images/user.png" alt="doctor pic"/>';}  
